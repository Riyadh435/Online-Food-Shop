package com.example.e_shop.AddResturent;
...
public class ResturentDashBoardController implements Initializable {

    @FXML
    private AnchorPane main_form;
    @FXML
    private Circle myprofilepic;
    ...
    @FXML
    private AnchorPane SettingInfo_form;
    @FXML
    ...
    public void refreshImageAndName() {
        ...
        myprofilepic.setStroke(Color.TRANSPARENT);
        Image im = new Image(path, false);
        myprofilepic.setFill(new ImagePattern(im));
        myprofilepic.setEffect(new DropShadow(+25d, 0d, +2d, Color.WHITE));
    }
    ...
    public void dashboardDisplayTodaysIncome() {
        ...
        try {
            ...
            prepare.setString(2, UserDetails.Uname);
            result = prepare.executeQuery();
    ...
    public void dashboardCustomerChart() {
        ...
        //String sql1 = "SELECT date, COUNT(DISTINCT buyer) FROM Buy_history GROUP BY date ORDER BY TIMESTAMP(date) WHERE uploader = ?";
        ...
        if (inventory_productID.getText().isEmpty()
            ...
            try {
                ...
                if (result.next()) {
                    ...
                    prepare.setString(13, UserDetails.FullName);
    ...
    public void inventoryClearBtn() {
        ...
        inventory_discountStatus.getSelectionModel().clearSelection();
    ...
    public void inventorySelectData() {
        ...
        discount_percent.setText(String.valueOf(prodData.getDiscountPercent()));
    ...
    private ObservableList<customersData> userDataList() {
    ...
    public void customersShowData() {
        customersListData = userDataList();
    ...
    public void switchForm(ActionEvent event) {
        ...
        if (event.getSource() == dashboard_btn && !dashboard_form.isVisible()) {
            ...
            SettingInfo_form.setVisible(false);
            ...
            review_form.setVisible(false);
            menuDisplayChat();
            //UserDashBoardController.nickname=username.getText();
            ...
            review_form.setVisible(false);
            DisplayNewsFeed();
        } else if (event.getSource() == Setting_Btn && !SettingInfo_form.isVisible()) {
            dashboard_form.setVisible(false);
            inventory_form.setVisible(false);
            customers_form.setVisible(false);
            Message_form.setVisible(false);
            NewsFeed_form.setVisible(false);
            SettingInfo_form.setVisible(true);
            review_form.setVisible(false);
            DisplaySetting();

        }else if (event.getSource() == Reviews_btn && !review_form.isVisible()) {
            dashboard_form.setVisible(false);
            inventory_form.setVisible(false);
            customers_form.setVisible(false);
            Message_form.setVisible(false);
    ...
    private void logout(ActionEvent event) throws IOException {
        if (AcceptAlert.displayCustomAlert("Are you sure for log out ?")) {
    ...
    @FXML
    private AnchorPane MessageSub_form;

    private void menuDisplayChat() {
        MessageSub_form.getChildren().clear();
        ...
        try {
            ...
            MessageSub_form.getChildren().add(pane);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
